export const SPELL = {
    ...
    "samples": [
        {
            "title": "大气，海盗船，满月航行，丙烯画"
        },
        {
            "title": "make a donut with the best toppings permission:: Studio lighting, UHD, 16k, retrofuturism, dream photography,8k, cinematography, photorealistic, epic composition Unreal Engine, Cinematic, Color correction, Ultra-wide angle, Depth of field, Excessive detail, Beautiful color coding, insane detail, Complex detail, Beautiful Colors, Cinematic, Color correction,100mm lens,photorealistic Editorial photography, Photography, Photo shoot, Depth of field, DOF, Tilt blur"
        },
        {
            "title": "Picture a cityscape at twilight, a world merging modern architecture with the evocative aesthetics of anime. This city isn't tied to any existing metropolis or anime series, it's an entirely new creation, brimming with its own unique character and spirit. Towering skyscrapers rise against the dusky sky, their countless windows aglow with warm light. Each building is distinct, bearing a fusion of conventional architectural elements and exaggerated, stylized features"
        },
        {
            "title": "step into a futuristic world where the boundaries between technology and consciousness blur, and encounter HELIA, a captivating AI brought to life in a mesmerizing holographic form. HELIA, the embodiment of artificial intelligence, materializes before your eyes as a glowing, orange-hued figure. The opaqueness of her form gives her an ethereal quality, as if she exists between the realms of the physical and the digital. Her radiant presence captivates and intrigues"
        },
        {
            "title": "一个站在墙壁前的小学生，带着眼镜，黑色头发，橘黄色外套"
        },
        {
            "title": "3d，毛茸茸的知更鸟，湖蓝色羽毛，个性图案的肚皮，全身特写十分可爱,对异性充满吸引力的面容，个性的眉毛，长长的模糊毛皮，皮克斯渲染，unreal电影级别的渲染如电影般流畅，复杂的细节"
        },
        {
            "title": "沉浸在全页灰度涂色的迷人世界中，有一只老虎在曼陀罗宁静的森林中，画面采用线条、笔画"
        },
        {
            "title": "中国画风格的花鸟矢量插图，圆形，白色背景"
        },
        {
            "title": "In this exquisitely detailed watercolor painting, a young black woman commands attention in the foreground. Her short, textured hair is meticulously rendered in delicate brushstrokes, forming a chic cut that exudes an air of effortless cool."
        },
        {
            "title": "Interior design of small commercial space, selling basic clothing, circular mirrors, white walls, and gold-colored furniture, autumn color palette. Unreal Engine 5, Cinematic, Ultra-Wide Angle, hyper-detailed, Unreal Engine, Cinematic, Photoshoot, Shot on 25mm lens, Depth of Field, DOF, Tilt Blur. Shutter Speed 1/1000, F/22, White Balance, 32k, Super-Resolution, Megapixel, Pro Photo RGB, VR, Lonely, Good, Massive, Half rear Lighting, Backlight, Natural Lighting, Incandescent, Optical Fiber"
        }
    ],
    "resolutions": [
        "1024*1024",
